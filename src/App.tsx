...
import CrewPage from './components/shift-entry/pages/CrewPage';
                    ...
                    <div className="glass rounded-3xl shadow-2xl overflow-hidden animate-slide-in border border-slate-800/40">
                        ...
                        {activePage === 'crew' && (
                            <CrewPage
                                formData={formData}
                                crewRows={crewRows}
                                expandedCrewRows={expandedCrewRows}
                                crewLocationOptions={crewLocationOptions}
                                bartenderDirectory={bartenderDirectory}
                                serverDirectory={serverDirectory}
                                supportDirectory={supportDirectory}
                                timeErrors={timeErrors}
                                SUPPORT_ROLE_OPTIONS={SUPPORT_ROLE_OPTIONS}
                                addBartenderRow={addBartenderRow}
                                addServerRow={addServerRow}
                                addSupportRow={addSupportRow}
                                toggleCrewRow={toggleCrewRow}
                                handleCrewNameInput={handleCrewNameInput}
                                getTimeDraftValue={getTimeDraftValue}
                                handleTimeDraftChange={handleTimeDraftChange}
                                commitCrewTime={commitCrewTime}
                                updateFormPath={updateFormPath}
