...
import styles from './CutsPage.module.css';

type CutsPageProps = {
  formData: any;
  expandedCuts: Record<string, boolean>;
  onToggleCut: (key: string) => void;
  onAddCut: () => void;
  onUpdate: (path: string, value: any) => void;
  onDeleteCut: (key: string) => void;
  onCancelCut: (key: string) => void;
  onSaveCut: (key: string) => void;
};

type CutEntry = [string, any];

const CutsPage: React.FC<CutsPageProps> = ({
  formData,
  expandedCuts,
  onToggleCut,
  onAddCut,
  ...
  const cutsEntries = Object.entries(formData.cuts || {}) as CutEntry[];
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-3 justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    type="text"
                    value={cut.me?.tips ?? ''}
                    onChange={(e) => onUpdate(`cuts.${key}.me.tips`, e.target.value)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                      ...
                      <input
                        type="text"
                        value={cut.label || ''}
                        onChange={(e) => onUpdate(`cuts.${key}.label`, e.target.value)}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => onUpdate(`cuts.${key}.status`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                      >
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={cut.me?.hours ?? ''}
                        onChange={(e) => onUpdate(`cuts.${key}.me.hours`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                        placeholder="0"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => onUpdate(`cuts.${key}.total.tips`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => onUpdate(`cuts.${key}.total.hours`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                        placeholder="optional"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                      ...
                      <input
                        type="text"
                        value={cut.share?.pct ?? ''}
                        onChange={(e) => onUpdate(`cuts.${key}.share.pct`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                        placeholder="optional"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => onUpdate(`cuts.${key}.share.people`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
                        placeholder="optional"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => onUpdate(`cuts.${key}.share.notes`, e.target.value)}
                        className="mt-1 w-full px-3 py-2 bg-slate-900/60 border border-slate-700 rounded-xl"
